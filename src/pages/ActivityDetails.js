...
export default function ActivityDetails() {
  const { menuorhistory } = useParams();
  const navigate = useNavigate(); 
  const [detailType, setDetailType] = useState(menuorhistory === "tarihce" ? "tarihce" : "menu");
    ...
    <div className='activity-details-container'>
      <div className='activity-details-back-button' onClick={()=>{
        ...
        <div className='activity-details-header'>
          <svg onClick={()=>{
            navigate("/home");
          }} width="178" height="59" viewBox="0 0 178 59" fill="none" xmlns="http://www.w3.org/2000/svg">
